...
//    }
    ...
    public static void main(String[] args){
        Student jessica = new Student(1245, "Jessica");
        System.out.println(jessica.getStudentDetails());
        Student seth = new Student(23545, "Seth");
        System.out.println(seth.getStudentDetails());
        Course math = new Course(1253, "Math");
        System.out.println(math.getCourseDetails());
        Enrollment fall = new Enrollment(jessica, math);
